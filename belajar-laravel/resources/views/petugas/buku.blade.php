        ...
        <table class="table table-striped table-hover table-responsive-lg table-bordered ">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('petugas.edit',['id' => $data->id]) }}" ><span class="mdi mdi-pencil fs-3"></span></a> | <a data-bs-toggle="modal" data-bs-target="#modal-hapus{{ $data->id }}" >
                ...
                <div class="modal fade" id="modal-hapus{{ $data->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            ...
                            <form action="{{ route('petugas.delete', ['id'=>$data->id]) }}"method="POST">
                                @csrf
                                @method('DELETE')
