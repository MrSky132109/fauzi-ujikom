...
<body id="section_1">
                ...
                <div class="col-lg-3 col-12 ms-auto d-lg-block d-none">
                    <ul class="social-icon">
                        <li class="social-icon-item">
                            <a href="{{ url('/about') }}" class="social-icon-link bi-twitter"></a>
                        </li>
    ...
    <main>
        ...
        <section class="section-padding section-bg" id="section_2">
          <h1 class="text-center">Populer Books</h1>
            <div class="card-group">
                <div class="row row-cols-1 row-cols-md-3 g-4 ms-2 mt-2">
                    <div class="col">
                <div class="card mb-3" style="max-width: 500px;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="images/cover/muslihat-berlian.jpg" class="img-fluid rounded-start" alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                      <h5 class="card-title md-2">Muslihat Berlian</h5>
                      <p class="card-text">Penulis : Tsugaeda.</p>
                      <p class="card-text">Penerbit : Tsugaeda.</p>
                      <p class="card-text">Pengarang : Tsugaeda.</p>
                      <p class="card-text">Genre : Tsugaeda.</p>
                ...
                <div class="card mb-3" style="max-width: 500px;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="images/cover/laut-bercerita.jpg" class="img-fluid rounded-start" alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
