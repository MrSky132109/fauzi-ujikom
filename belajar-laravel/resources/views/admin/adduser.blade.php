    ...
    @enderror
        <form action="inputuser" method="POST">
            ...
            {{-- <div class="mb-1">
                ...
                <input type="file" name="image" value="{{ old('image')}}"class="form-control shadow-none p-2 mb-5 bg-light rounded border-end-0 border-top-0 border-bottom-0 border-dark border-2" id="image" >
            </div> --}}
            <div class="mb-1">
            ...
            <div class="mb-1">
                ...
                <select name="role" id="genre" value="{{ old('role') }}"class="form-control shadow-none p-2 mb-5 bg-light rounded border-end-0 border-top-0 border-bottom-0 border-dark border-2"required>
