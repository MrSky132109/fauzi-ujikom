        ...
        <table class="table table-striped table-hover table-responsive-lg table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $data1->role }}</td>
                    <td>{{ $data1->status }}</td>
                    <td><a href="{{ route('admin.edituser',['id' => $data1->id]) }}" ><span class="mdi mdi-pencil fs-3"></span></a> | <a data-bs-toggle="modal" data-bs-target="#modal-hapus{{ $data1->id }}" >
                ...
                <div class="modal fade" id="modal-hapus{{ $data1->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <form action="{{ route('admin.deleteuser', ['id'=>$data1->id]) }}"method="POST">
                            @csrf
                            @method('DELETE')
